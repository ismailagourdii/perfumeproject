// Types partagés SCENTARA — miroir de /docs/shared-types.ts pour le build Next.js.
...
export interface CartItemBase {
  ...
  kind: CartItemKind;
  quantity: number;
  /** Image URL for display (e.g. from perfume.imageUrl). Filled by store when adding. */
  image?: string;
}
